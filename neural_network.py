...
class NeuralNetwork:
  ...
  def __init__(self):
    # Tells it to use the same random numbers each time
    random.seed(1)
    self.synaptic_weights = self.__get_synaptic_stating_weights()


  def __get_synaptic_stating_weights(self, num_connections, ):
